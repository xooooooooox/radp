...
- Allow multiple MyBatis auto-fill strategies to run for the same entity so BasePO audit fields can coexist with custom
...
- scaffold
  - Update scaffold default radpVersion to `2.20.2`
  - Optimize `.mvn`
  - Add `.gitattributes`
