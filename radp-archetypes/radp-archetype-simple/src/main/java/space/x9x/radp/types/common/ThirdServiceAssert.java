...
/**
 * Third-party service assertion utility that throws ThirdServiceException when assertions fail.
 *
 * @author x9x
...
public class ThirdServiceAssert extends BaseAssert<ThirdServiceException> {
    ...
    /**
     * Static method to get an instance of ThirdServiceAssert for use in static contexts.
     */
    public static ThirdServiceAssert assertThat() {
        return INSTANCE;
    }
