...
- Primary rule
  - Junie MUST NOT generate fully qualified type names (FQN) in Java/Groovy source. Always add imports and use simple (
    unqualified) type names.
  - This applies to production code, tests, annotations, generics, static method calls, Javadoc examples, and code
    snippets embedded in comments.
