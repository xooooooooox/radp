...
public final class ClientAssert extends BaseAssert<ClientException> {
	...
	/**
	 * singleton instance of the ClientAssert class.
	 */
	private static final ClientAssert INSTANCE = new ClientAssert();

	/**
	 * returns a function that creates a ClientException with the specified error code and
	 * message.
	 * @return a function that creates a ClientException
	 */
	@Override
	 ...
	 * returns a function that creates a ClientException with the specified error code and
	 * formatted message.
	 * @return a function that creates a ClientException with a formatted message
	 */
	@Override
	 ...
	 * throwing a ClientException with the specified error code if it does.
	 ...
	 * ClientException with the specified error code if it doesn't.
	 ...
	 * character), throwing a ClientException with the specified error code if it doesn't.
	 ...
	 * ClientException with the specified error code if it isn't.
	...
	/**
	 * asserts that the specified object is null, throwing a ClientException with the
	...
	/**
	 * asserts that the specified object is not null, throwing a ClientException with the
	...
	/**
	 * asserts that the specified expression is true, throwing a ClientException with the
	 * specified error code if it isn't.
	 ...
	 * ClientException with the specified error code if it does.
	...
	/**
	 * asserts that the specified array is not empty, throwing a ClientException with the
	 * specified error code if it is.
	...
	/**
	 * asserts that the specified collection is not empty, throwing a ClientException with
	...
	/**
	 * asserts that the specified map is not empty, throwing a ClientException with the
	 * specified error code if it is.
	 ...
	 * throwing a ClientException with the specified error code if it isn't.
	 ...
	 * a ClientException with the specified error code if it isn't.
	 * @param expression the boolean expression to check
	 * @param errCode the error code to use in the exception
	 * @param placeholders the placeholders to use in the error message
	 * @throws ClientException if the expression is false
