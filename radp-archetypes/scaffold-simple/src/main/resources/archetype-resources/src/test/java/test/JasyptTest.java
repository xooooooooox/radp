...
import ${package}.jasypt.spring.boot.util.JasyptUtils;
...
class JasyptTest {
    ...
    void test() {
        ...
        for (String plainText : plainTexts) {
            ...
            JasyptUtils.customPBEEncrypt(plainText, "PBEWithMD5AndDES", "dsaf${symbol_pound},jds.klfj1");
        }
        ...
        Assertions.assertEquals("root", JasyptUtils.customPBEDecrypt("0R/8uhwNlqioUF0hbuJZWA==", "PBEWithMD5AndDES", "dsaf${symbol_pound},jds.klfj1"));
        Assertions.assertEquals("123456", JasyptUtils.customPBEDecrypt("lTEOkXx15CN6dH48COhuVA==", "PBEWithMD5AndDES", "dsaf${symbol_pound},jds.klfj1"));
    }
}