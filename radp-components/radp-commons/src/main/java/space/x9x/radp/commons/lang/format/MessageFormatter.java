...
public class MessageFormatter {
	 ...
	 * <p>
	 * This method is useful for message formatting patterns where the last argument might
	 * be an exception that should be handled specially.
	 ...
	 * <p>
	 * This method is typically used in conjunction with {@link #getThrowableCandidate} to
	 * separate the exception from the rest of the arguments for message formatting.
