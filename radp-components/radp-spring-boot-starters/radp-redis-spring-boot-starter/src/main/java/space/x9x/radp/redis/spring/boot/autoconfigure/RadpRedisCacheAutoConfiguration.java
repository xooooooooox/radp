...
public class RadpRedisCacheAutoConfiguration {
    ...
    /**
     * Log message used when the Redis cache configuration is autowired.
     * This message is logged at debug level when the configuration is initialized.
     */
    private static final String AUTOWIRED_REDIS_CACHE_CONFIGURATION = "Autowired redisCacheConfiguration";

    /**
     * Log message used when the Redis cache manager is autowired.
     * This message is logged at debug level when the manager is initialized.
     */
    private static final String AUTOWIRED_REDIS_CACHE_MANAGER = "Autowired redisCacheManager";

    /**
     * Log message used when the Redisson service is autowired.
     * This message is logged at debug level when the service is initialized.
     */
     ...
     * This bean configures how Spring's cache abstraction interacts with Redis, including:
     * - Custom value serialization using the application's standard Redis serializer
     * - Time-to-live settings from cache properties
    ...
    /**
     * Creates a Redis cache manager with enhanced timeout capabilities.
     * This bean provides a cache manager that uses the application's Redis connection
     * and cache configuration, with additional features:
     * - Non-locking cache operations for better performance
     * - Batch scanning strategy with configurable batch size
     * - Custom TimeoutRedisCacheManager implementation for enhanced timeout handling
     *
    ...
    /**
     * Creates a Redisson service that provides enhanced Redis operations.
     * This bean wraps a RedissonClient to provide a simplified and consistent API
     * for working with various Redis data structures and features, including:
