...
/**
 * Interface for Redis key providers that standardizes key management across different
 * modules.
 * <p>
 * Implementing this interface allows different modules to define their own Redis key
...
public interface IRedisKeyProvider {
	 ...
	 * <p>
	 * This is a convenience method for creating keys in the format: prefix:feature
	 ...
	 * <p>
	 * This is a convenience method for creating keys in the format: prefix:entity:id
	 ...
	 * <p>
	 * This method can be used to validate that a key follows the expected format and
	 * belongs to the correct namespace.
	 ...
	 * <p>
	 * This method extracts the part after the prefix. For example, if the prefix is
	 * "app:module" and the key is "app:module:entity:id", this method returns "entity".
	 * <p>
	 * If the key doesn't have enough parts or doesn't belong to this namespace, returns
	 * null.
	 ...
	 * <p>
	 * This method extracts the part after the entity. For example, if the prefix is
	 * "app:module" and the key is "app:module:entity:id", this method returns "id".
	 * <p>
	 * If the key doesn't have enough parts or doesn't belong to this namespace, returns
	 * null.
	 * @param key the Redis key
	...
	/**
	 * Validates that a Redis key belongs to this provider's namespace and follows the
	 * standard format.
