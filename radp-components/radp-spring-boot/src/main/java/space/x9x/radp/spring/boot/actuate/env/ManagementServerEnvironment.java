...
/**
 * Constants for Spring Boot Actuator management server configuration properties. This
...
public class ManagementServerEnvironment {
	...
	/**
	 * Property name for the management server port configuration. This constant defines
	 * the Spring Boot property name used to configure the port on which the Spring Boot
	 * Actuator management server runs.
	 */
	public static final String PORT = "management.server.port";

	/**
	 * Property name for the web endpoints base path configuration. This constant defines
	 * the Spring Boot property name used to configure the base path for all web endpoints
