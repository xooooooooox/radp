...
public class ManagementServerEnvironmentInboundParser implements EnvironmentInboundParser {
	...
	public String toString(Environment env) {
		...
		int port = NumberUtil.toInt(env.getProperty(ManagementServerEnvironment.PORT));
		String basePath = StringUtil.trimToEmpty(env.getProperty(ManagementServerEnvironment.ENDPOINTS_WEB_BASE_PATH));
