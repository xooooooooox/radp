        ...
        return new AbstractClusterInvoker<T>(directory) {
            ...
            private String getLocalHost() {
                ...
                final String host = RpcContext.getClientAttachment().getAttachment(DubboAttachments.IP) != null ?
                        RpcContext.getClientAttachment().getAttachment(DubboAttachments.IP) :
             ...
             * @return 调用结果
             */
            private Result invokeRemoteService(Directory<T> directory, Invocation invocation, 
                    List<Invoker<T>> invokers, LoadBalance loadbalance, String localHost) {
