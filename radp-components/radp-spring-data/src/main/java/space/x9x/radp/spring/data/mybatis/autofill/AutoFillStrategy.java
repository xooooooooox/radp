 ...
 * fields during INSERT and UPDATE operations. This decouples the autofill logic from a
...
public interface AutoFillStrategy {
	 ...
	 * @param entity the current entity resolved from a mybatis metaobject (never null)
	 * @return true if this strategy should handle autofill for the entity
	 */
