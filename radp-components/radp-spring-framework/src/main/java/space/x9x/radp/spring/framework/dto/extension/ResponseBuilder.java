...
public interface ResponseBuilder<T> {
	...
	/**
	 * Builds a failure response with the specified error code and parameters. The error
	 * message is loaded from the resource bundle using the error code.
	...
	/**
	 * Builds a failure response with the specified error code, custom error message, and
	 * parameters. This method allows overriding the error message from the resource
	 * bundle.
	 ...
	 * @return a response object indicating failure with the error details
	 */
	T buildFailure(@PropertyKey(resourceBundle = ErrorCodeLoader.BUNDLE_NAME) String errCode, String errMessage,
			Object... params);

	/**
	 * Builds a failure response with the specified ErrorCode object. The error code and
	 * message are extracted from the ErrorCode object.
