...
/**
 * Base exception class for all application-specific exceptions. This class provides
 * standardized error handling with error codes, messages, and optional parameters. It
 * serves as the parent class for more specific exception types.
 *
 * @author IO x9x
...
public class BaseException extends RuntimeException {
	 ...
	 */
	public BaseException(@PropertyKey(resourceBundle = ErrorCodeLoader.BUNDLE_NAME) String errCode, Throwable t) {
		super(ErrorCodeLoader.getErrMessage(errCode), t);
		// The super constructor takes both message and cause, ensuring the exception's
		// stack trace is preserved
		// We get the error message without trying to replace placeholders with the
		// exception message
	...
	/**
	 * Constructs a new BaseException with the specified error code, message pattern, and
	 * parameters. The message pattern is used directly as the error message, and the
	 * parameters can be used for message formatting or to provide a cause for the
	 * exception.
	 ...
	 * @param params the parameters to be used for message formatting or to provide a
	 * cause
	 */
	...
	/**
	 * Constructs a new BaseException with the specified error code and parameters. The
	...
	/**
	 * Constructs a new BaseException with the specified ErrorCode object. The error code
	 * and message are extracted from the ErrorCode object.
	 ...
	 * The error code and message are extracted from the ErrorCode object, and the
	 * parameters are used for message formatting.
	 * @param errorCode the ErrorCode object containing the error code and message
	 * @param params the parameters to be substituted in the error message
	 */
	...
	/**
	 * Constructs a new BaseException with the specified ErrorCode object and throwable
	 * cause. The error code is extracted from the ErrorCode object, and the error message
	 * is formatted with the throwable's message.
	 * @param errorCode the ErrorCode object containing the error code and message
	 * template
	 * @param t the throwable cause of this exception
	 */
