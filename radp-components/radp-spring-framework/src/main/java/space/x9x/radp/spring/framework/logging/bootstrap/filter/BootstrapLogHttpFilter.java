...
public class BootstrapLogHttpFilter extends HttpFilter {
	...
	protected void doFilter(HttpServletRequest req, HttpServletResponse res, FilterChain chain)
		...
		if (this.enabledMdc) {
			String appName = StringUtils.trimToEmpty(this.env.getProperty(SpringProperties.SPRING_APPLICATION_NAME));
			String profile = StringUtils.trimToEmpty(String.join(Strings.COMMA, getActiveProfiles(this.env)));
