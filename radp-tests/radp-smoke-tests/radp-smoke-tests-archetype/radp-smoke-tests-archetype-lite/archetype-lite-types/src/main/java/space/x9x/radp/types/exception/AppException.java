...
/**
 * Application-specific exception class that extends the ServerException.
 * This exception is used to represent application-level errors with specific error codes.
 *
 * @author IO x9x
...
public class AppException extends ServerException {
	...
	/**
	 * Constructs an AppException with the specified error code, message pattern, and parameters.
	 *
	 * @param errCode the error code from the resource bundle
